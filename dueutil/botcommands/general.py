...
def shop_weapons_list(page, **details):
    ...
    shop_list = weap_cmds.weapons_page(shop_weapons, page, "V3Util's Weapon Shop!",
...
def shop_theme_list(page, **details):
    ...
    shop_list = player_cmds.theme_page(themes, page, "V3Util's Theme Shop!",
                                       footer_more=("But wait there's more! Do "
...
def shop_background_list(page, **details):
    ...
    shop_list = player_cmds.background_page(backgrounds, page, "V3Util's Background Shop!",
                                            footer_more="But wait there's more! Do "
...
def shop_banner_list(page, **details):
    ...
    shop_list = player_cmds.banner_page(banners, page, "V3Util's Banner Shop!",
...
async def shop(ctx, *args, **details):
    ...
    if len(args) == 0:
        # Greet
        greet = ":wave: **Welcome to the V3Util general store!**\n"
