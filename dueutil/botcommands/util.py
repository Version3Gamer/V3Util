...
async def help(ctx, *args, **details):
    ...
    help_embed = discord.Embed(title="V3Util's Help", type="rich", color=gconf.DUE_COLOUR)
    ...
    if len(args) == 1:
        ...
        help_embed.add_field(name=e.THINKY_FONK + " Tips",
                             value=("If V3Util reacts to your command it means something is wrong!\n"
        ...
        help_embed.add_field(name=":link: Links", value=("**Invite me: %s**\n" % gconf.BOT_INVITE
                                                         ...
                                                         + "V3Util Server: https://discord.gg/D2uekue\n"))
        help_embed.add_field(name=e.WEISS_SMUG + " Bot going down?",
                             value=("If V3Util goes down go to the V3Util Server to find out why!\n"
                                    + ":thinking: Now you can spread the word!"))
...
async def botinfo(ctx, **_):
    ...
    info_embed = discord.Embed(title="V3Util's Information", type="rich", color=gconf.DUE_COLOUR)
    info_embed.description = "V3Util is customizable bot to add fun commands, quests and battles to your server."
    info_embed.add_field(name="Created by", value="[MacDue#4453](https://dueutil.tech/)and revived by [Seth#4987]")
